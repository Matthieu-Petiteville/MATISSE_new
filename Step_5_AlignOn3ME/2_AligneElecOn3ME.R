...
#Dans le mode non forfait, on utilise la réduction de conso d'électricité du mode forfait
if(redistribution != "forfait"){
  ...
  rm(menage_echelle_calibre, menage_echelle_calibre_ele)
}
